...
public class ProductDetailsUI {
	...
	public static final String EMPTY_MSG = "//div[@class='page-body']//div[@class='no-data']";
	...
	//Order
	public static final String ADD_TO_CART_BUTTON_PRODUCT_DETAILS = "//input[@value='Add to cart']";
}
